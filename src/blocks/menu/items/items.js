...
const items = {
  ...
  other: [
    ...
    },
    {
      ...
      price: "10",
      description:
        "Холодный кофейный напиток на основе свежевыжатого апельсинового фреша с домашней карамелью (или любым другим сиропом, я не знаю с чем вы там обычно готовите) и двойным эспрессо.",
