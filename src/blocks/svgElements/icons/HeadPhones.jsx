export default function HeadPhones({size}){
    return (
      <div
        style={{
          width: `${size}px`,
      ...
      >
        ...
        >
          ...
          >
            <path
              d="M2300 4953 c-497 -76 -934 -342 -1223 -744 -79 -110 -204 -356 -246
          ...
          -1072 553 -131 18 -383 18 -509 -2z"
            />
            <path
              d="M683 1247 c9 -66 61 -209 106 -293 145 -269 393 -464 689 -541 73
          -19 132 -26 242 -30 l146 -6 0 92 1 91 -101 0 c-126 0 -208 13 -313 49 -273
          94 -494 325 -573 600 l-24 81 -89 0 -90 0 6 -43z"
            />
            <path
              d="M2280 777 c-142 -40 -236 -167 -234 -318 2 -118 72 -227 182 -281 46
